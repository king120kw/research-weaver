...
export default function HistoryScreen({ onNavigate }: HistoryScreenProps) {
    ...
    const historyItems = [
        {
            id: 1,
            title: "The Impact of Quantum Computing on Cryptography.pdf",
            type: "document",
            date: "Oct 26, 2023",
            status: "Verified",
            icon: "description",
        ...
        {
            id: 2,
            title: "Discussion on renewable energy sources",
            type: "chat",
            date: "2 hours ago",
            status: "Verified",
            icon: "forum",
        ...
        {
            id: 3,
            title: "Advancements in Machine Learning for Medical Imaging.docx",
            type: "document",
            date: "Oct 25, 2023",
            status: "Processing",
            icon: "description",
