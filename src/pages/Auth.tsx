      ...
      <Card className="w-full max-w-md shadow-2xl border-border/50 backdrop-blur-sm bg-background/80 relative z-10">
        <CardHeader className="space-y-3 text-center pb-8">
          ...
          <CardDescription className="text-base">
            Sign in with your Google account to access your research workspace
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <Button
            ...
            size="lg"
            className="w-full h-12 text-base font-medium bg-blue-600 hover:bg-blue-700 text-white transition-all rounded-lg shadow-md hover:shadow-lg"
          >
          ...
          <p className="text-xs text-center text-muted-foreground px-4">
            Sign in with your Gmail or Google account. By signing in, you agree to our Terms of Service and Privacy Policy.
